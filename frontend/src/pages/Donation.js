...
const Donation = () => {
  ...
  const handleDonationSubmit = async (e) => {
    ...
    try{
      ...
      // console.log(data);
      setDonationMessage("Donation Successfull");
    }catch(error){
  ...
  useEffect(() => {
    ...
    const initializeMap = () => {
      ...
      const marker = L.marker([26.283340, 73.021860], { draggable: true }).addTo(map); // Add a draggable marker
  ...
  return (
    <div className="donation-body">
      <div className="head-description">
        <h1>Donate Food with  <span className="site-name">Greener GRUB</span></h1>
    ...
    setDonationData({ ...donationData, email: e.target.value })
            ...
            <div className="Food">
              <input
                ...
                value={donationData.Food}
  onChange={(e) =>
    setDonationData({ ...donationData, Food: e.target.value })
  }
                required
              />
            </div>
